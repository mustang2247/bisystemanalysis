...
public final class SentenceWordCountTopology {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Config.setComponentRam(conf, "spout", ByteAmount.fromMegabytes(512));
    Config.setComponentRam(conf, "split", ByteAmount.fromMegabytes(512));
    Config.setComponentRam(conf, "count", ByteAmount.fromMegabytes(512));

    // container resource configuration
    Config.setContainerDiskRequested(conf, ByteAmount.fromGigabytes(3));
    Config.setContainerRamRequested(conf, ByteAmount.fromGigabytes(3));
