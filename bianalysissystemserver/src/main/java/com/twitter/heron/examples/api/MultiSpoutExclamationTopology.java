...
public final class MultiSpoutExclamationTopology {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Config.setComponentRam(conf, "word0",
        ExampleResources.getComponentRam());
    Config.setComponentRam(conf, "word1",
        ExampleResources.getComponentRam());
    Config.setComponentRam(conf, "word2",
        ExampleResources.getComponentRam());
    Config.setComponentRam(conf, "exclaim1",
        ExampleResources.getComponentRam());
    ...
    Config.setContainerCpuRequested(conf, 1);
