...
public final class ComponentJVMOptionsTopology {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Config.setComponentJvmOptions(conf, "word", "-XX:NewSize=300m");
    Config.setComponentJvmOptions(conf, "exclaim1", "-XX:NewSize=800m");

    // component resource configuration
    Config.setComponentRam(conf, "word", ByteAmount.fromMegabytes(512));
    Config.setComponentRam(conf, "exclaim1", ByteAmount.fromMegabytes(512));

    // container resource configuration
    Config.setContainerDiskRequested(conf, ByteAmount.fromGigabytes(2));
    Config.setContainerRamRequested(conf, ByteAmount.fromGigabytes(2));
