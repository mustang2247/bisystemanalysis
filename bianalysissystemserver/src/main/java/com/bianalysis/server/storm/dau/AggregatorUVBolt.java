...
/**
 * 将PartialUVBolt的数据聚合起来，根据不同的type计算当前周期的数据汇总，汇总完毕的数据发射到PersistenceUVBolt中
 */
public class AggregatorUVBolt extends BaseRichBolt {

    private static final Logger logger = LoggerFactory.getLogger(AggregatorUVBolt.class);
